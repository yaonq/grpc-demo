...
type Request struct {
	...
	DogId int32 `protobuf:"varint,1,opt,name=dogId,proto3" json:"dogId,omitempty"`
}
...
type Response struct {
	...
	Data *Dog `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
...
var file_proto_server_proto_rawDesc = []byte{
	...
	,
...
var file_proto_server_proto_depIdxs = []int32{
	1, // 0: Response.data:type_name -> Dog
	2, // 1: Response.msg:type_name -> Msg
	0, // 2: DogService.GetDogInfo:input_type -> Request
	3, // 3: DogService.GetDogInfo:output_type -> Response
...
type DogServiceClient interface {
	GetDogInfo(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *dogServiceClient) GetDogInfo(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/DogService/GetDogInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DogServiceServer interface {
	GetDogInfo(context.Context, *Request) (*Response, error)
}

// UnimplementedDogServiceServer can be embedded to have forward compatible implementations.
type UnimplementedDogServiceServer struct {
}

func (*UnimplementedDogServiceServer) GetDogInfo(context.Context, *Request) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDogInfo not implemented")
}
...
func _DogService_GetDogInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DogServiceServer).GetDogInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/DogService/GetDogInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DogServiceServer).GetDogInfo(ctx, req.(*Request))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _DogService_GetDogInfo_Handler,
		},
	},
