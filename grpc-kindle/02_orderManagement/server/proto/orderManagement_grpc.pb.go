...
func (c *orderManagementClient) UpdateOrders(ctx context.Context, opts ...grpc.CallOption) (OrderManagement_UpdateOrdersClient, error) {
	stream, err := c.cc.NewStream(ctx, &OrderManagement_ServiceDesc.Streams[1], "/proto.OrderManagement/updateOrders", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *orderManagementClient) ProcessOrders(ctx context.Context, opts ...grpc.CallOption) (OrderManagement_ProcessOrdersClient, error) {
	stream, err := c.cc.NewStream(ctx, &OrderManagement_ServiceDesc.Streams[2], "/proto.OrderManagement/processOrders", opts...)
	if err != nil {
		return nil, err
	}
...
var OrderManagement_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/orderManagement.proto",
}
